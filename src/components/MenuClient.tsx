  ...
  return (
    <div className="min-h-dvh bg-brand-parchment dark:bg-[#0D0804] transition-colors duration-300">
      ...
      <header ref={heroRef} className="hero-surface relative grain overflow-hidden">
        {/* Ramas de cafeto a los lados del título */}
        ...
        <div ref={langWrapRef} className="absolute top-4 right-4 z-20">
          <button
            ...
            className="flex items-center justify-center w-8 h-8 rounded-lg bg-white/15 hover:bg-white/25 transition-colors active:scale-90"
          >
            <svg
              ref={langGlobeRef}
              className="w-[18px] h-[18px] text-brand-honey"
        ...
        <div className="relative z-10 max-w-lg mx-auto px-6 pt-16 pb-14 text-center">
          ...
          <h1 className="hero-title font-serif font-light text-[76px] sm:text-[92px] leading-none tracking-[-0.02em] text-brand-cream [text-shadow:1.5px_2px_0_rgba(184,114,42,0.4),0_5px_14px_rgba(0,0,0,0.45)] sm:[text-shadow:2px_3px_0_rgba(184,114,42,0.55),0_8px_20px_rgba(0,0,0,0.6)]">
            Plenty.
          </h1>
