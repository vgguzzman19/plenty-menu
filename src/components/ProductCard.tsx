...
export function ProductCard({ product, lang, onClick }: Props) {
  ...
  if (product.price === 0) {
    return (
      <div className="product-card flex items-center gap-2 bg-white dark:bg-brand-espresso border border-brand-stone/50 dark:border-brand-roast rounded-full px-4 py-2.5 w-fit">
    ...
    <div
      ...
      className={`product-card group rounded-2xl transition-all duration-200 p-5 ${
        unavailable
          ...
          : "bg-white dark:bg-brand-espresso shadow-card dark:shadow-none dark:ring-1 dark:ring-brand-roast hover:shadow-card-hover dark:hover:ring-brand-caramel/40 hover:-translate-y-0.5"
